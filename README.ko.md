...
DevTalk는 VS Code와 Cursor의 Activity Bar에서 사용할 수 있는 작은 팀 채팅 도구입니다. 처음 실행할 때 이름을 입력하고, Supabase Realtime을 통해 같은 방에 있는 사람들과 메시지를 주고받습니다.
...
Supabase 프로젝트를 만든 뒤, public Storage bucket을 생성하세요.
...
작은 친구/팀 그룹용으로는 아래 Storage policy를 사용할 수 있습니다.
